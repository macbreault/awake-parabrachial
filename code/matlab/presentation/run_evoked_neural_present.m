...
mouse_id = 'C6';                     % Mouse ID
date_str = '7-27-22';                     % Date of recording
...
for mouse = 1:numel(mouse_ids)
    ...
    for d = 1:numel(dates)
        ...
        H.mainLine.DisplayName = 'Pre Conditioning';%strrep(exper_cond,'_',' ');
        h(1) = H.mainLine;
        yline(thresh,'k')
        ...
        uniformFormat(fig)
        if save_it
            savefig(fig,fullfile(plot_path,'2_evoked_neural.fig'))
